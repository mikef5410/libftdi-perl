...
*CBUSG_DRIVE1 = *FTDIc::CBUSG_DRIVE1;
...
*CBUSH_BAT_DETECT = *FTDIc::CBUSH_BAT_DETECT;
*CBUSH_BAT_DETECT_NEG = *FTDIc::CBUSH_BAT_DETECT_NEG;
*CBUSH_I2C_TXE = *FTDIc::CBUSH_I2C_TXE;
*CBUSH_I2C_RXF = *FTDIc::CBUSH_I2C_RXF;
*CBUSH_VBUS_SENSE = *FTDIc::CBUSH_VBUS_SENSE;
*CBUSH_BB_WR = *FTDIc::CBUSH_BB_WR;
*CBUSH_BB_RD = *FTDIc::CBUSH_BB_RD;
*CBUSH_TIME_STAMP = *FTDIc::CBUSH_TIME_STAMP;
*CBUSH_AWAKE = *FTDIc::CBUSH_AWAKE;
