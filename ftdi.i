...
#endif
#ifdef SWIGPERL
%module(docstring="Perl interface to libftdi") FTDI
#endif
...
#endif
#ifdef SWIGPERL
%typemap(argout,fragment="SWIG_FromCharPtrAndSize") unsigned char *buf %{ $result = SWIG_FromCharPtrAndSize((char*)$1,FTDI_MAX_EEPROM_SIZE); %}
#endif
